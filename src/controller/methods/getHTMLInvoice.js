export const getHTMLInvoice = (invoiceNo, formattedDate, totalCost, nit, name, cartItems, currency) => {
    ...
    * {
    ...
    <table style="font-family:arial,helvetica,sans-serif; background-color: white; padding-top: 25px;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      <tbody style="background-color: white; padding-top: 250px; height: 20px;">
        <tr>
          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 40px;font-family:arial,helvetica,sans-serif;" align="left">
            <div style="padding-top: 35px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
              <img src="https://i.ibb.co/NYqg7Qd/Screenshot-from-2023-11-15-23-26-49.png" width="200px" alt="">
              <p style="padding: 120px; padding-top: 10px; padding-bottom: 0; text-align: center; font-family: 'Poppins', sans-serif;">Sip, Click, Enjoy</p>
              <p style="padding: 120px; padding-bottom: 40px; padding-top: 0px; text-align: center; font-family: 'Poppins', sans-serif;">Elevate Your Thirst Experience!</p>
            </div>
          </td>
        </tr>
      </tbody>
    ...
    const productsHtml = products.map((product) => `
      <table id="u_content_heading_5" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
              <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 18px; font-weight: 400;"><strong>${product.productInfo.name}</strong></h1>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table id="u_content_heading_6" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
              <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 18px; font-weight: 400;"><strong>${product.quantity}</strong></h1>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table id="u_content_heading_7" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        <tbody>
          <tr>
            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
              <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 18px; font-weight: 400;"><strong>${product.productInfo.price.value}</strong></h1>
            </td>
          </tr>
        </tbody>
      </table>
